...
pomExtra := (
  <url>https://github.com/sadikovi/spark-dataset</url>
  <scm>
    <url>git@github.com:sadikovi/spark-dataset.git</url>
    <connection>scm:git:git@github.com:sadikovi/spark-dataset.git</connection>
  </scm>
  <developers>
    <developer>
      <id>sadikovi</id>
